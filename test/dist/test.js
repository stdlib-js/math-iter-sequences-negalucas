...
var iterNegaLucasSeq = require( './../../dist' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof iterNegaLucasSeq, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object which generates a negaLucas sequence', function test( t ) {
	var expected;
	var actual;
	var it;
	var i;
...
tape( 'if an environment supports `Symbol.iterator`, the returned iterator is iterable', function test( t ) {
	var iterNegaLucasSeq;
	var it1;
	var it2;
	var i;

	iterNegaLucasSeq = proxyquire( './../dist/main.js', {
		'@stdlib/symbol-iterator': '__ITERATOR_SYMBOL__'
	});

	it1 = iterNegaLucasSeq();
